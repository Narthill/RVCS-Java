...
public class UserController {
    ...
    @ApiImplicitParam(name = "user", value = "用户信息",required = true, paramType = "body",dataType="UserInfo")
    @PostMapping(value = "/register")
    public Object register(@RequestBody UserInfo user) throws AuthenticationException {
